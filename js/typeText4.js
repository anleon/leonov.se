...
//					console.log($(".image #text_foto").height());
	...
	//				var endTime = 0;
					...
					console.log("(endTime.getTime()-startTime.getTime())-totalDelay: "+(((endTime.getTime()-startTime.getTime())-totalDelay)));
					console.log("(((endTime.getTime()-startTime.getTime())-totalDelay))*465: "+(((endTime.getTime()-startTime.getTime())-totalDelay))*465);
				}
				i = 0;
			}
		}
